import typedInputs from './__fixtures__/variableRateMortgage.inputs';

describe('simulate a variable rate mortgage', () => {
  ...
  it('should run the simulation', () => {
    ...
    expect(messages[1][0].res[0][49].buyer.$).toBeCloseTo(4470901, 0);
    expect(messages[1][0].res[0][49].buyer.house.$).toBeCloseTo(1842707, 0);
    expect(messages[1][0].res[0][49].buyer.portfolio.$).toBeCloseTo(2628194, 0);
    expect(messages[1][0].res[0][49].renter.$).toBeCloseTo(3684440, 0);
    expect(messages[1][0].res[0][49].renter.house.$).toBe(0);
    expect(messages[1][0].res[0][49].renter.portfolio.$).toBeCloseTo(3684440, 0);
  });
});
